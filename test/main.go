...
//              client           server
//
// crowbar and tcpforwarder binaries should be in your PATH
...
func main() {
	...
	hd := exec.Command("tcpforwarder", "server",
		// "-v",
		"--key", "foobar",
		"--port", "2002")
	hd.Stdout = os.Stdout
	...
	hf := exec.Command("tcpforwarder", "client",
		// "-v",
